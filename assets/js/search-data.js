...
ninja.data = [{
    ...
    handler: () => {
      ...
      },{id: "post-주제-추천-react-native를-활용한-크로스-플랫폼-모바일-앱-개발-블로그-제목-react-native를-이용해-본격-크로스-플랫폼-모바일-앱-개발에-도전하기",
        
          title: "주제 추천: React Native를 활용한 크로스 플랫폼 모바일 앱 개발 블로그 제목: React...",
